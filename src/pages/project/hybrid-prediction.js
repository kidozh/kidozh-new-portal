  ...
  <Layout>
    <section className="bg-gray-50 dark:bg-slate-600">
      <div className="w-full mx-auto max-w-(--breakpoint-xl) px-6 py-32">
        ...
        <h1
          class="text-6xl md:text-8xl text-center font-bold bg-linear-to-bl from-[#FF0000] via-[#FF6400] via-[#FFA816] via-[#FF9A87] via-[#F747D1] to-[#AD5DF1] bg-clip-text text-transparent">
