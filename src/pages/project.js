    ...
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl overflow-hidden
        ...
        <div className="px-8 py-12">
            ...
            <hr className="h-1 my-8 w-16 mt-2 mb-6 bg-orange-500
             border-2 dark:bg-indigo-500 group-hover:bg-slate-100" />

            <p className="mt-4 font-montserrat text-sm font-light text-gray-700 dark:text-gray-400 group-hover:text-gray-200">{keywords}</p>
        </div>
    </div>
);
